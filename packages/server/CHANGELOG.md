...
* ### Adds @soda3js/server Package
  ...
  `standalone.ts` entry script for running the server outside Vitest. Dockerfile for containerized fixture replay. Configurable via `SODA3_SERVER_MODE`, `SODA3_SERVER_PORT`, `SODA3_FIXTURES_PATH`, and chaos/record env vars. [#53][#53]

### Minor Changes

Thanks to [@spencerbeggs](https://github.com/spencerbeggs) for their contributions!

[#53]: https://github.com/soda3js/tools/pull/53
